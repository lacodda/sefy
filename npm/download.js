// Downloads the sefy binary matching this package version from GitHub Releases.
...
const REPO = "lacodda/sefy";
// The wrapper can be patched independently of the Rust binary: an explicit
// sefy.binary field pins the release tag, otherwise it follows the version.
const TAG = (pkg.sefy && pkg.sefy.binary) || `v${pkg.version}`;
...
const exe = process.platform === "win32" ? "sefy.exe" : "sefy";
