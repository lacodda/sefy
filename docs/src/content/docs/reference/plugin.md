...
`sefy plugin` reports on the transports installed here — what sefy can see, and
why it will not run anything it refuses. Moving the vault is done by
...
github  0.10.0    pull, push
sftp    0.10.0    pull, push
```
